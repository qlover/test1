...
const mapDispatchToProps = (dispatch) => {
    // return {
    //     // 将一个 action 操作绑定到属性中
    //     // 如果出现多个，则可以利用 bindActionCreators 将多个绑定成一个
    //     update: (...args) => dispatch(userInfoActions.update(...args)),
    //     get: (...args) => dispatch(userInfoActions.get(...args)),
    //     set: (...args) => dispatch(userInfoActions.set(...args))
    // }

        // 如果利用 bindActionCreators 则直接可以将 action 注入进 props 中
    return {
